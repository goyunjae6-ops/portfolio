...
export default function Hero() {
  ...
  return (
    ...
    <section id="hero" className="hero-section relative z-10 overflow-hidden bg-cream pt-24 sm:pt-28 md:pt-32">
      ...
      <div className="mx-auto grid w-full max-w-[1920px] gap-8 px-6 pb-10 sm:px-10 md:grid-cols-2 md:items-start md:gap-6 md:px-12 md:pb-0 lg:hidden">
        <div className="order-2 flex flex-col items-center pt-2 text-center md:order-1 md:items-start md:pt-[8%]">
          ...
          <p ref={mLine3} className="leading-[1.3] text-[clamp(1.5rem,4vw,5rem)]">
            <span className="name-mobile font-semibold text-ink underline decoration-[rgba(201,169,110,0.55)] decoration-[7px] underline-offset-[11px]">고윤재</span>{" "}
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-5 md:justify-start">
            <Button as="a" href="https://drive.google.com/file/d/1wLQz_KdGNbyDXVfEPuBPd0OJ6jeWAF9a/view?usp=sharing" target="_blank" rel="noopener noreferrer" variant="dark" size="lg" className="btn-press border-2 border-white">
              📄 이력서 보기
            </Button>
      ...
      <a href="https://drive.google.com/file/d/1wLQz_KdGNbyDXVfEPuBPd0OJ6jeWAF9a/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="hero-btn btn-resume btn-press hidden lg:flex">
        📄 이력서 보기
      </a>
